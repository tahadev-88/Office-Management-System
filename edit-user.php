...
<html>
<head>
	<title>Edit Employee | Digitazio Panel</title>
		...
		<section class="flex-1 p-8 bg-white min-h-screen">
			<div class="mb-8">
				<div class="flex justify-between items-center mb-6">
					<h1 class="text-heading-sm font-poppins font-semibold text-eerie-black">Edit Employee</h1>
			...
			<div class="max-w-2xl mx-auto">
				<div class="bg-white rounded-lg shadow-digitazio p-8">
					<form method="POST" action="app/update-user.php" class="space-y-6">
						...
						<div class="space-y-4">
							...
							<div>
								...
								<p class="text-body-sm font-poppins text-gray-500 mt-1">Leave blank to keep current password</p>
							</div>
							...
							<div>
								...
								<select name="job" 
									...
									<option value="Video Editor" <?= ($user['job'] == 'Video Editor') ? 'selected' : '' ?>>Video Editor</option>
									<option value="Salesman" <?= ($user['job'] == 'Salesman') ? 'selected' : '' ?>>Salesman</option>
									...
									<option value="Content Writer" <?= ($user['job'] == 'Content Writer') ? 'selected' : '' ?>>Content Writer</option>
									<option value="Marketing Manager" <?= ($user['job'] == 'Marketing Manager') ? 'selected' : '' ?>>Marketing Manager</option>
									<option value="Social Media Manager" <?= ($user['job'] == 'Social Media Manager') ? 'selected' : '' ?>>Social Media Manager</option>
									<option value="Data Analyst" <?= ($user['job'] == 'Data Analyst') ? 'selected' : '' ?>>Data Analyst</option>
									<option value="Customer Support" <?= ($user['job'] == 'Customer Support') ? 'selected' : '' ?>>Customer Support</option>
									<option value="Project Manager" <?= ($user['job'] == 'Project Manager') ? 'selected' : '' ?>>Project Manager</option>
									<option value="Software Developer" <?= ($user['job'] == 'Software Developer') ? 'selected' : '' ?>>Software Developer</option>
									<option value="HR Manager" <?= ($user['job'] == 'HR Manager') ? 'selected' : '' ?>>HR Manager</option>
								</select>
							</div>
